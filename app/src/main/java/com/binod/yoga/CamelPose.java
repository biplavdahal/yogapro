...
public class CamelPose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image.setImageResource(R.drawable.camelpose);
        pose.setText("Camel pose");
        howToDoAns.setText(getString(R.string.camelpose));
        benefitsAns.setText(getString(R.string.camelposebenefits));
        constraintLayout.setBackgroundColor(getResources().getColor(R.color.camel));
        color.setBackgroundColor(getResources().getColor(R.color.camel));


        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(CamelPose.this,TimerActivity.class);
    ...
    public void initializeButton()
    {
        ...
        button.setBackgroundColor(getResources().getColor(R.color.camel));
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
