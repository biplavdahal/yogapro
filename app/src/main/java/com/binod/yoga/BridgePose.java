...
public class BridgePose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image.setImageResource(R.drawable.bridgepose);
        pose.setText("Bridge pose");
        howToDoAns.setText(getString(R.string.bridgepose));
        benefitsAns.setText(getString(R.string.bridgeposebenefits));
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(BridgePose.this,TimerActivity.class);
