...
public class IntenseSideStretch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image.setImageResource(R.drawable.intensesidestretch);
        pose.setText("Intense side stretch");
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(IntenseSideStretch.this,TimerActivity.class);
