...
public class UpwardFacingDog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image.setImageResource(R.drawable.upwardfacingdog);
        pose.setText("Upward facing dog");
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(UpwardFacingDog.this,TimerActivity.class);
